<?php
/**
 * SmashZone - Badminton Clothing Category (clothing.php)
 * Powered by PHP & MySQL database smashZone
 */

require_once __DIR__ . '/includes/db.php';

$pageTitle = "Badminton Clothing & Apparel — Dry-Fit Jerseys, Shorts & Caps | SmashZone Sri Lanka";
$pageMetaDesc = "Shop badminton jerseys, court shorts, athletic caps, sleeveless vests, and socks in Sri Lanka. Yonex, Li-Ning, Victor, Hundred, SmashZone. 100% Authentic.";
  ...
  <section class="category-page-hero">
    <div class="container">
      <div class="category-breadcrumb">
        ...
        <i class="bi bi-chevron-right small"></i>
        <span class="active-item">Clothing & Apparel</span>
      </div>

      <h1 class="category-hero-title">Badminton <span class="text-orange">Clothings</span></h1>
      <p class="category-hero-desc">
        Breathable dry-fit jerseys, court shorts, athletic caps, sleeveless vests, socks, and skorts from <strong>Yonex, Li-Ning, Victor, Hundred, and SmashZone</strong>. Formatted in Sri Lankan Rupees (Rs.).
      </p>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="d-lg-none mb-3">
        <button class="btn-mobile-filter-trigger w-100 justify-content-center py-2 fs-6" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas">
          <i class="bi bi-funnel-fill text-warning"></i> Filter Apparel (Brand, Category, Gender, Price)
        </button>
      </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-3 d-none d-lg-block">
          <div class="filter-sidebar-card">
            ...
            <!-- Search Within Apparel -->
            <div class="filter-group-block">
              <div class="filter-group-heading">Search Apparel</div>
              <div class="position-relative">
                <input type="text" id="clothingSearchInput" class="form-control form-control-sm rounded-pill ps-4" placeholder="Jersey, shorts, cap, socks...">
            ...
            <div class="filter-group-block">
              ...
              <div class="filter-options-list">
                ...
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="brandCheck" value="SmashZone">
                    <span class="fw-bold text-dark">SmashZone</span>
                  </span>
            ...
            <div class="filter-group-block">
              <div class="filter-group-heading">Apparel Category</div>
              <div class="filter-options-list">
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="categoryCheck" value="Match Jersey">
                    <span>Match Jerseys</span>
                  </span>
                </label>
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="categoryCheck" value="Court Shorts">
                    <span>Court Shorts</span>
                  </span>
                </label>
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="categoryCheck" value="Cap / Visor">
                    <span>Caps & Visors</span>
                  </span>
                </label>
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="categoryCheck" value="Sleeveless Vest">
                    <span>Sleeveless Vests</span>
                  </span>
                </label>
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="categoryCheck" value="Court Socks">
                    <span>Court Socks</span>
                  </span>
                </label>
                <label class="custom-filter-check">
                  <span class="filter-check-label">
                    <input type="checkbox" class="categoryCheck" value="Court Skort">
                    <span>Court Skorts</span>
                  </span>
                </label>
              </div>
            </div>
            ...
            <div class="filter-group-block">
              ...
              <div class="price-range-wrapper">
                <input type="range" id="priceSlider" class="price-slider-input" min="2000" max="20000" step="1000" value="20000">
                <div class="price-inputs-display">
                  <span>Up to:</span>
                  <span id="priceDisplay" class="text-orange">Rs. 20,000</span>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-9">
          ...
          <div class="products-toolbar-card">
            <p class="products-count-text">
              Showing <strong id="clothingCount">16</strong> Apparel Products
            </p>
          ...
          <div class="row g-4" id="clothingGrid"></div>
